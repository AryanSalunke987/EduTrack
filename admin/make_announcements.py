...
class MakeAnnouncements(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        self.announcement_entry = ctk.CTkTextbox(self, height=200, width=1200, font=("Calibri", 22))  
        self.announcement_entry.pack(pady=20, padx=10)
        ...
        self.announcement_listbox = ctk.CTkTextbox(self, height=300, width=600, font=("Calibri", 18))  # Increased font size to 12
